    ...
    <Transition appear show={isOpen} as={Fragment}>
        ...
        <Transition.Child 
         ...
         >
          ...
          overflow-y-auto transform rounded-2xl bg-white text-left p-6  
            ...
            <div className='flex-1 flex flex-col gap-3'>
                ...
                <div className='flex gap-3 '>
                    <div className='flex-1 relative w-full h-24 bg-primary-blue-100 rounded-lg'> 
                      <Image src={generateCarImageUrl(bike,'29')} alt="car model" fill priority className="object-contain" />
                     </div>

                     <div className='flex-1 relative w-full h-24 bg-primary-blue-100 rounded-lg'> 
                      <Image src={generateCarImageUrl(bike,'33')} alt="car model" fill priority className="object-contain" />
                     </div>

                     <div className='flex-1 relative w-full h-24 bg-primary-blue-100 rounded-lg'> 
                      <Image src={generateCarImageUrl(bike,'13')}  alt="car model" fill priority className="object-contain" />
                     </div>
                </div>
            </div>
